...
HD_PWD='/home/andrew/ECE532-sandbox/MNIST_Solver/MNIST_Solver.runs/Mult_Add_Pipelined_COL_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult_Add_Pipelined_COL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mult_Add_Pipelined_COL.tcl
