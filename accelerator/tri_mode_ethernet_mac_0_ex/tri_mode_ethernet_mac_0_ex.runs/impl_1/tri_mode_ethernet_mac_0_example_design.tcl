...
set rc [catch {
  ...
  open_checkpoint tri_mode_ethernet_mac_0_example_design_routed.dcp
  ...
  catch {write_debug_probes -quiet -force tri_mode_ethernet_mac_0_example_design}
  catch {file copy -force tri_mode_ethernet_mac_0_example_design.ltx debug_nets.ltx}
