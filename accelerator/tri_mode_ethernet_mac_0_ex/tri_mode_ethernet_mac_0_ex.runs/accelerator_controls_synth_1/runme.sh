...
HD_PWD='/home/quinn/ece532-project/accelerator/tri_mode_ethernet_mac_0_ex/tri_mode_ethernet_mac_0_ex.runs/accelerator_controls_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerator_controls.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accelerator_controls.tcl
