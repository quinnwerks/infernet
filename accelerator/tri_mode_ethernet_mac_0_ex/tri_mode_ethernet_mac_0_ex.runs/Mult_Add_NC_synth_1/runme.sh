...
HD_PWD='/home/quinn/ece532-project/accelerator/tri_mode_ethernet_mac_0_ex/tri_mode_ethernet_mac_0_ex.runs/Mult_Add_NC_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult_Add_NC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mult_Add_NC.tcl
