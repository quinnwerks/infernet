...
HD_PWD='/home/quinn/ece532/tutorials/tut5/project/project.runs/design_1_mdm_1_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mdm_1_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mdm_1_3.tcl
