...
{
	iki_sensitize(dp, "xsim.dir/Conv_Kernel_TB_behav/xsim.reloc");
}
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 913760, dp + 893224, 0, 47, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 966688, dp + 893560, 48, 95, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1019576, dp + 893896, 96, 143, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1072464, dp + 894232, 144, 191, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1125352, dp + 894568, 192, 239, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1178240, dp + 894904, 240, 287, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1231128, dp + 895240, 288, 335, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1284016, dp + 895576, 336, 383, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1336864, dp + 895912, 384, 431, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1400032, dp + 1391048, 0, 47, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1452960, dp + 1391384, 48, 95, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1505848, dp + 1391720, 96, 143, 0, 47, 48, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1558696, dp + 1392056, 0, 47, 0, 47, 48, 1);

}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/Conv_Kernel_TB_behav/xsim.reloc");
	wrapper_func_0(dp);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/Conv_Kernel_TB_behav/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/Conv_Kernel_TB_behav/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/Conv_Kernel_TB_behav/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, 0, isimBridge_getWdbWriter(), 0, argc, argv);
