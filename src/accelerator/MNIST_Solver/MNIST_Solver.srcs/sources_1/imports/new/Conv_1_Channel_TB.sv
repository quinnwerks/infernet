...
module Conv_1_Channel_TB(
    ...
    logic signed [17:0] ibuf_data_in, ibuf_data_out, obuf_data_in, obuf_data_out;
    ...
    Conv_1_Channel #(
        .weights('{'{18'b1_1111101_1001100110, 18'b1_1111110_0010110100, 18'b0_0000011_1100100110}, 
    ...
    initial begin
        ...
        for (int row = 0; row < 28; row++) begin
            for (int col = 0; col < 28; col++) begin
                ...
                obuf_rcol = col;
                #PERIOD;
                difference = expected[row][col] - obuf_data_out;
